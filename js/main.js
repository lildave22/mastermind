...
let chronos = 30;
let firstclick = true;
/*let bout = document.querySelector(".form");*/


let tour = 1;

console.log(val1, val2, val3, val4);
/*bout.addEventListener('click', (event) => {
if(play){
 if(firstclick){
     firstclick = false;
...
const valid = () => {
   ...
   /* function setTime (){
        if(play){
            chronos--;
            if(chronos <= 10){
                document.querySelector('.time').getElementsByClassName.color = "red";
            }
            if(chronos <= 0){
                play = false;
            }
            ...
            document.querySelector('.time').innerHTML = "Le temps imparti est écoulé";
        }
    }*/
}